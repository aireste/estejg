    ...
    >
      <div className="container-x flex items-center justify-end">
        ...
        <div className="hidden md:flex items-center gap-8">
          <a href="#about" className="font-mono text-xs uppercase tracking-[0.14em] hover:text-amber transition-colors link-underline">
            About
          </a>
          <a href="#work" className="font-mono text-xs uppercase tracking-[0.14em] hover:text-amber transition-colors link-underline">
            Work
          </a>
